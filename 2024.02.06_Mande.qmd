...
## Genetic classification of Mande by [@valentin09]
...
tibble(lang = lang.aff("Mande,"), 
  ...
  mutate(aff = str_remove_all(aff, "^Mande, "),
         ...
         size = ifelse(lang %in% c("Guro", "Dan", "Guinea Kpelle", "Loma (Liberia)", "Bambara", "Mann"), 6, 3),
         label = ifelse(lang %in% c("Guro", "Dan", "Guinea Kpelle", "Loma (Liberia)", "Bambara", "Mann"), lang, ""),
